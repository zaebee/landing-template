...
class SadsProcessingContext$Type extends MessageType<SadsProcessingContext> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SadsProcessingContext): SadsProcessingContext {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SadsProcessingContext, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool is_dark_mode = 1; */
...
class ResolveSadsStylesRequest$Type extends MessageType<ResolveSadsStylesRequest> {
    ...
    create(value?: PartialMessage<ResolveSadsStylesRequest>): ResolveSadsStylesRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ResolveSadsStylesRequest): ResolveSadsStylesRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ResolveSadsStylesRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class ResolveSadsStylesResponse$Type extends MessageType<ResolveSadsStylesResponse> {
    ...
    create(value?: PartialMessage<ResolveSadsStylesResponse>): ResolveSadsStylesResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.cssRules = "";
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ResolveSadsStylesResponse): ResolveSadsStylesResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ResolveSadsStylesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string css_rules = 1; */
        if (message.cssRules !== "")
