...
class PortfolioItem$Type extends MessageType<PortfolioItem> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: PortfolioItem): PortfolioItem {
    ...
    internalBinaryWrite(message: PortfolioItem, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string id = 1; */
        if (message.id !== "")
