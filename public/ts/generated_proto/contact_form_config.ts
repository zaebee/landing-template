...
class ContactFormConfig$Type extends MessageType<ContactFormConfig> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ContactFormConfig): ContactFormConfig {
    ...
    internalBinaryWrite(message: ContactFormConfig, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
