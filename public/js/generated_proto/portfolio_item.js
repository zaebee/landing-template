...
class PortfolioItem$Type extends MessageType {
    constructor() {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* website_content.v1.TitledBlock details */ 3:
                    message.details = TitledBlock.internalBinaryRead(reader, reader.uint32(), options, message.details);
                    break;
                default:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.details)
            TitledBlock.internalBinaryWrite(message.details, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
