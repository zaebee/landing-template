    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* website_content.v1.I18nString subtitle */ 2:
          message.subtitle = I18nString.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.subtitle
...
class HeroItem$Type extends MessageType {
      ...
      switch (fieldNo) {
        case /* repeated website_content.v1.HeroItemContent variations */ 1:
          message.variations.push(
            HeroItemContent.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    for (let i = 0; i < message.variations.length; i++)
      HeroItemContent.internalBinaryWrite(
    ...
    if (message.defaultVariationId !== "")
      writer
        ...
        .string(message.defaultVariationId);
    let u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? UnknownFieldHandler.onWrite : u)(
        this.typeName,
