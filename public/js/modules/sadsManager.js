 ...
 * @async
 */
export async function initSadsEngine() {
    ...
    if (SADSEngine && !sadsEngineInstance) {
        ...
        const defaultTheme = window.sadsDefaultTheme || {};
        ...
        console.error("SADSEngine class not found. SADS styles will not be applied by sadsManager.");
    }
}
/**
 ...
 * @async
 */
export async function reapplySadsStyles() {
    if (sadsEngineInstance && typeof sadsEngineInstance.applyStyles === "function") {
        ...
        if (!sadsEngineInstance) {
            console.warn("sadsManager: SADSEngine instance is not available. " +
...
//# sourceMappingURL=sadsManager.js.map